...
Welcome to the contributor guide of mantaray py.
...
If you experience bugs or general issues with mantaray py, please have a look
...
You can help improve the documentation of mantaray py by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/mantaray-py.git
   cd mantaray-py
   ```
